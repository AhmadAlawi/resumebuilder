...
const PrivacyPolicy: NextPage = () => (
  <div className="prose mx-auto my-12 dark:prose-invert">
    ...
    <p>
      Like any other website, Cashmere Solutions uses &apos;cookies&apos;. These cookies are used to store information
    ...
    <p>
      ...
      their respective advertisements and links that appear on Cashmere Solutions, which are sent directly to
    ...
    <p>
      Cashmere Solutions&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
