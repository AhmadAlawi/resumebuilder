...
const PrivacyPolicy: NextPage = () => (
  <div className="prose mx-auto my-12 dark:prose-invert">
    <h1>Privacy Policy for Cashmere-Solutions</h1>

    <p>
      At Cashmere Solutions, accessible from www.Cashmere-solutions.com, one of our main priorities is the privacy of
    ...
    <p>
      ...
      the information that they shared and/or collect in Cashmere Solutions. This policy is not applicable to any
    ...
    <p>
      Cashmere Solutions follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <p>
      Like any other website, Cashmere Solutions uses 'cookies'. These cookies are used to store information including
    ...
    <p>
      You may consult this list to find the Privacy Policy for each of the advertising partners of Cashmere Solutions.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on Cashmere Solutions, which are sent directly to users'
    ...
    <p>
      Note that Cashmere Solutions has no access to or control over these cookies that are used by third-party
      advertisers.
    </p>
    ...
    <p>
      Cashmere Solutions's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>
      Cashmere Solutions does not knowingly collect any Personal Identifiable Information from children under the age of
