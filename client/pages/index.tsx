...
import { DIGITALOCEAN_URL, GITHUB_URL } from '../constants';
      ...
      <section className={styles.section}>
        ...
        <p className="my-3">
          <Trans t={t} i18nKey="landing.testimonials.body">
            Good or bad, I would love to hear your opinion on Resume Builder and how the experience has been for you.
            <br />
        ...
        <p className="my-3">
          <Trans t={t} i18nKey="landing.testimonials.contact">
            You can reach out to us through <a href="mailto:info@cashmere-solutions.com">Our Email</a> or through the
            contact form on <a href="https://www.cashmere-solutions.com">Our website</a>.
          </Trans>
        </p>
