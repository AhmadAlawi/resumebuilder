...
const testimonials: Testimony[] = [
  ...
  //   {
  //     name: 'Chandani B.',
  //     message: `Hi Amruth, Thank you for creating Resume Builder and keeping it open source. I am about to use it in updating my profile and therefore wanted to express my gratitude.
  ...
  //   {
  //     name: 'Aadith R.',
  //     message: `Hey, I just found out about Resume Builder through a co-worker and it's damn good. Minimalist, Contains all the necessary things and is also editable.`,
  //   },
  //   {
  //     name: 'Krzysztof W.',
